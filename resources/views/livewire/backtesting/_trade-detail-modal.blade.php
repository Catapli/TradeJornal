            ...
            <div>
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-white/70"
                               x-text="detailTrade.session ? detailTrade.session.replace('_', ' ').toUpperCase() : 'Sin sesión'"></p>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-5">
                    ...
                    <div class="col-span-2 space-y-4 border-r border-gray-100 p-5">
                        ...
                        {{-- Precios --}}
                        <div>
                            <p class="mb-2 text-xs font-semibold uppercase tracking-wide text-gray-400">Precios</p>
                            <div class="space-y-2">
                        ...
                        {{-- Calidad --}}
                        <div>
                            <p class="mb-2 text-xs font-semibold uppercase tracking-wide text-gray-400">Setup</p>
                            <div class="space-y-2">
                                {{-- Stars --}}
                                <div class="flex items-center justify-between">
                        ...
                        <div x-show="detailTrade.confluences && detailTrade.confluences.length > 0">
                            <p class="mb-2 text-xs font-semibold uppercase tracking-wide text-gray-400">Confluencias</p>
                        ...
                        <div x-show="detailTrade.notes">
                            <p class="mb-2 text-xs font-semibold uppercase tracking-wide text-gray-400">Notas</p>
                    ...
                    <div class="relative col-span-3 flex min-h-64 items-center justify-center bg-gray-100">
                        ...
                        <template x-if="!detailTrade.screenshot">
                            <div class="flex flex-col items-center gap-3">
                                ...
                                <p class="text-sm font-medium text-gray-400">Sin screenshot</p>
                                <p class="text-xs text-gray-300">Edita el trade para añadir uno</p>
                            </div>
                        </template>
                    </div>
                </div>
