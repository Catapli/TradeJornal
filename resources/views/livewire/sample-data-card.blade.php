...
<div>
    ...
    @elseif (! $hasTrades)
        <div class="mb-5 flex flex-col gap-4 rounded-2xl border border-indigo-200 bg-indigo-50 px-5 py-5 dark:border-indigo-500/30 dark:bg-indigo-500/10 sm:flex-row sm:items-center sm:justify-between">
            <div class="flex items-start gap-3">
                <i class="fa-solid fa-wand-magic-sparkles mt-1 text-indigo-600 dark:text-indigo-400"></i>
                <div>
                    <p class="text-sm font-bold text-indigo-900 dark:text-indigo-200">{{ __('sample.cta_title') }}</p>
                    <p class="mt-0.5 max-w-2xl text-xs text-indigo-800 dark:text-indigo-300/90">{{ __('sample.cta_text') }}</p>
                </div>
            </div>
