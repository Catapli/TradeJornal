<div class="mt-4 rounded-xl border border-rose-100 bg-white shadow-sm transition-all duration-300 dark:border-rose-500/20 dark:bg-gray-900/30"
     x-data="{ open: false }"> {{-- Estado Alpine para abrir/cerrar --}}

    {{-- CABECERA (Siempre visible) --}}
    <div class="flex cursor-pointer items-center justify-between bg-rose-50/50 px-4 py-3 dark:bg-rose-500/10"
         @click="open = !open">
            ...
            <div class="mt-4 flex items-center gap-2 border-t border-gray-100 pt-2 dark:border-gray-700">
                <div class="flex -space-x-1">
                    @foreach ($selectedMistakes as $id)
                        <div class="h-2 w-2 rounded-full bg-rose-500 ring-2 ring-white dark:ring-gray-800"></div>
                    @endforeach
                </div>
