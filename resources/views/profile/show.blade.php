<x-app-layout>
    <div class="mt-14 min-h-screen bg-gray-50 dark:bg-gray-900 pb-20 pt-6">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            {{-- Título de Sección --}}
            <div class="mb-8">
                <h2 class="text-2xl font-black text-gray-900 dark:text-gray-100">Configuración de Cuenta</h2>
                <p class="text-sm text-gray-500 dark:text-gray-400">Gestiona tus credenciales y la conexión con el Agente MT5.</p>
            </div>
            ...
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                ...
                <div class="space-y-6 lg:col-span-1">
                    ...
                    <div class="overflow-hidden rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm">
                        ...
                        <div class="border-t border-gray-100 dark:border-gray-700 px-6 py-4">
                            ...
                            <div class="mt-3 flex items-center justify-between text-sm">
                                ...
                                <span class="font-medium text-gray-900 dark:text-gray-100">{{ Auth::user()->created_at->format('d M, Y') }}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="overflow-hidden rounded-xl border border-indigo-100 bg-white dark:bg-gray-800 shadow-sm">
                        <div class="border-b border-indigo-50 px-6 py-4">
                            ...
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Usa este token en el Agente Python.</p>
                        </div>
                        <div class="p-6">
                            <div class="relative"
                                 x-data="{ copied: false }">
                                <input class="block w-full rounded-lg border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 py-3 pl-4 pr-12 font-mono text-sm text-gray-600 dark:text-gray-300 focus:border-indigo-500 focus:ring-indigo-500"
                                       type="text"
                                       readonly
                                       value="{{ Auth::user()->sync_token ?? 'NO_TOKEN_GENERATED' }}" />

                                <button class="absolute right-2 top-2 rounded-md p-1.5 text-gray-400 dark:text-gray-500 hover:bg-white dark:hover:bg-gray-800 hover:text-indigo-600 hover:shadow-sm"
