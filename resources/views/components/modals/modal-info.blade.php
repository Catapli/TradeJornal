                        ...
                        <div class="col-span-6 px-3 py-2">
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-12 items-center rounded-b-md rounded-r-md border border-solid border-gray-300 bg-white p-2 shadow-lg transition-all duration-300"
                                    ...
                                    {{-- ? Nombre Listado --}}
                                    <x-input-group id="list_name"
                                                   class="col-span-6"
                                                   x-model="$wire.list_name"
                                                   disabled="true"
                                                   placeholder="{{ __('labels.list_name') }}"
                                                   icono=" <i class='fa-solid fa-clipboard-list'></i>"
                                                   tooltip="{{ __('labels.list_name') }}" />
                                    ...
                                    {{-- ? Motivo --}}
                                    <x-input-group id="reason"
                                                   class="col-span-6"
                                                   x-model="$wire.reason"
                                                   disabled="true"
                                                   placeholder="{{ __('labels.reason') }}"
                                                   icono=" <i class='fa-solid fa-triangle-exclamation'></i>"
                                                   tooltip="{{ __('labels.reason') }}" />
                                    ...
                                    {{--
                                    {{~~ ? Modelo ~~}}
                                    <x-input-group id="model"
                                                   class="col-span-6"
                                                   x-model="$wire.model"
                                                   disabled="true"
                                                   placeholder="{{ __('labels.model_null') }}"
                                                   icono=" <i class='fa-solid fa-copyright'></i>"
                                                   tooltip="{{ __('labels.model') }}" /> --}}
                                    ...
                                    {{--       {{~~ ? Velocidad ~~}}
                                    <x-input-group id="vlc"
                                                   class="col-span-6"
                                                   x-model="$wire.vlc"
                                                   disabled="true"
                                                   placeholder="{{ __('labels.velocity_null') }}"
                                                   icono=" <i class='fa-solid fa-gauge-high'></i>"
                                                   tooltip="{{ __('labels.velocity') }}" /> --}}
                                    {{-- ?    Descripcion --}}
                                    <x-textarea-group class="col-span-12"
                                                      x-model="$wire.description"
                                                      disabled="true"
                                    ...
                                    {{-- ?   Observaciones  --}}
                                    <x-textarea-group class="col-span-12"
                                                      x-model="$wire.observations"
                                                      disabled="true"
                                                      placeholder="{{ __('labels.observations') }}"
                                                      icono="<i class='fa-solid fa-circle-exclamation'></i>"
                                                      tooltip="{{ __('labels.observations') }}" />
                                </div>
