<a href="/">
    ...
    <img class="h-20 w-auto rounded-xl border border-black object-contain dark:hidden"
         src="{{ asset('img/logo_trader_h.webp') }}"
         alt="TradeForge">
    <img class="hidden h-20 w-auto object-contain brightness-0 invert dark:block"
